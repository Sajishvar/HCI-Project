                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-logo">
                            <a href="index.html">
                                <img src="assets/images/logo/logo-white.svg" alt="" width="150">
                            </a>
                        </div>
                        <div class="footer-infor">
                            <ul>
                                <li>
                                    <p>Address: 1234 Main Street, Suite 567, <br> Colombo 05</p>
                                </li>
                                <li>
                                    <p>Email: <a href="#">PCmart@gmail.com</a></p>
                                </li>
                                <li>
                                    <p>Phone: <a href="#">(059) 555-1234</a></p>
                                </li>
                            </ul>
                            ...
                            <div class="tf-collapse-content">
                                ...
                                <div class="tf-cur">
                                    <div class="tf-currencies">
                                        <select
                                            class="image-select center style-default type-currencies color-white">
                                            <option data-thumbnail="assets/images/country/fr.svg">EUR <span>€ |
                                                    France</span></option>
                                            <option data-thumbnail="assets/images/country/de.svg">EUR <span>€ |
                                                    Germany</span></option>
                                            <option selected data-thumbnail="assets/images/country/us.svg">USD
                                                <span>$ | United States</span>
                                            </option>
                                            <option data-thumbnail="assets/images/country/vn.svg">VND <span>₫ |
                                                    Vietnam</span></option>
                                        </select>
                                    </div>
                                    <div class="tf-languages">
                                        <select
                                            class="image-select center style-default type-languages color-white">
                ...
                <div class="row">
                    <div class="col-12">
                        <div
                            ...
                            <div class="footer-menu_item">© 2024 PCmart. All Rights Reserved</div>
