        ...
        <div class="row justify-content-center">
            <div class="col-xl-4 col-lg-6 col-md-8">
                <div class="tf-page-cart-checkout">
                    ...
                    <p class="mb_20">Hey there. We tried to charge your card but, something went wrong. Please update
                        your payment method below to continue</p>
                    <a href="checkout.html"
                        class="tf-btn mb_20 w-100 btn-fill animate-hover-btn radius-3 justify-content-center">
                        <span>Update Payment Method</span>
                    </a>
                    <p>Have a question? <a href="contact-1.html" style="color: red;">Contact Support</a></p>
